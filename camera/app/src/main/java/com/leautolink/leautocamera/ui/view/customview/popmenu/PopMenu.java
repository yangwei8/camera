package com.leautolink.leautocamera.ui.view.customview.popmenu;
...
public class PopMenu {
    ...
    private void buildAnimateGridLayout() {
        ...
        mGridLayout.setBackgroundColor(Color.parseColor("#f00e0e0e"));
        ...
        int topMargin = (mScreenHeight - (itemWidth + vPadding) * rowCount + vPadding) * 5 / 6;
        ...
        mCloseIv.setImageResource(R.drawable.close);
...
//        mAnimateLayout.setOnTouchListener(new View.OnTouchListener() {
//
//            @Override
...
//            springs.get(i).setCurrentValue(mScreenHeight);
//        }
//
