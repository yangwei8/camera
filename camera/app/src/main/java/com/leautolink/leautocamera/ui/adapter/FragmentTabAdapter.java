        ...
        for (int i = 0; i < rgs.getChildCount(); i++) {
            if (rgs.getChildAt(i).getId() == checkedId) {
                ...
                if (null != onRgsExtraCheckedChangedListener) {
                    needChecked = onRgsExtraCheckedChangedListener.OnRgsExtraCheckedChanged(radioGroup, checkedId, i);
                }
                if (needChecked) {
                    ...
                    switch (i) {
                        case 2:
                            if (currentTab>=2) {
                                rgs.check(rgs.getChildAt(currentTab+1).getId());
                            }else {
